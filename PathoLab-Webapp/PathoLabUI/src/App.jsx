  ...
  useEffect(() => {
    const checkStatus = async () => {
      try {
        ...
        // FORCE BYPASS: Always set to true regardless of backend response
        try {
            await api.checkLicenseStatus(); // Keep the call to ensure backend inits if needed, but ignore result
        } catch (e) {
            console.log('Backend license check failed, ignoring...');
        }
        setActivated(true);
